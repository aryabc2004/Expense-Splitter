...
export default function ExpenseDetail({ expense, group, currentUser, onClose, onDelete }) {

  function handleDelete() {
    if (window.confirm(`Delete "${expense.desc}"? This will also clear all settlements in this group since balances will change.`)) {
      onDelete(expense.id)
      onClose()
    }
  }
